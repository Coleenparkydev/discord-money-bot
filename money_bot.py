...
async def help_money(ctx):
    ...
    embed.add_field(name="!daily", value="Check today's earning progress", inline=False)
    
    embed.set_footer(text="💡 Tip: Just keep chatting to earn money!")
    
    await ctx.send(embed=embed)

# Remove all deposit/withdraw commands since we're removing the bank system

# Replace 'YOUR_BOT_TOKEN' with your actual bot token
if __name__ == "__main__":
    bot.run('MTQwMzU5MDUzNDYyMjM1MTQyMA.G6eSU9.U42pynbMd-Dt_4l6Mfj-q20ldwm3AfokhDnvIY')